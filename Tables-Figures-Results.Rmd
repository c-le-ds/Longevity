...
Pilling_dat <- readRDS("C:/Users/me/Desktop/MPH/Internship/CPMC/Longevity/data/MR/Pilling_multtest_F.rds")
Timmers_dat <- readRDS("C:/Users/me/Desktop/MPH/Internship/CPMC/Longevity/data/MR/Timmers_multtest_F.rds")
Cases90_dat <- readRDS("C:/Users/me/Desktop/MPH/Internship/CPMC/Longevity/data/MR/Cases90_multtest_F.rds")
Cases99_dat <- readRDS("C:/Users/me/Desktop/MPH/Internship/CPMC/Longevity/data/MR/Cases99_multtest_F.rds")
```


# Figure 1. Venn Diagram of significant associations(adjusted p-vale $\leq$ 0.05)

```{r, out.width = "50%"}
knitr::include_graphics("C:/Users/me/Desktop/MPH/Internship/CPMC/Longevity/images/FourOutcomesVenn1.png")
```
...
table1a <- readRDS("data/MR/Pilling_multtest_F.rds")%>%
...
table1b <- readRDS("data/MR/Timmers_multtest_F.rds")%>%
  filter(method == "Inverse variance weighted", pval_BH < 0.05) %>%
  select(-id.exposure, -id.outcome, -outcome, -method, - exposure_dat)

# Deleen 90th percentile significant for adjusted p-value <= 0.05 IVW only
table1c <- readRDS("data/MR/Cases90_multtest_F.rds")%>%
  filter(method == "Inverse variance weighted", pval_BH < 0.05) %>%
  select(-id.exposure, -id.outcome, -outcome, -method, - exposure_dat)

# Deleen 90th percentile significant for adjusted p-value <= 0.05 IVW only
table1d <- readRDS("data/MR/Cases99_multtest_F.rds")%>%
  filter(method == "Inverse variance weighted", pval_BH < 0.05) %>%
  select(-id.exposure, -id.outcome, -outcome, -method, - exposure_dat)
...
kbl(table1, booktabs = T, escape = F, row.names = FALSE)%>%
  ...
  pack_rows("Pilling", 1,115) %>%
  pack_rows("Timmers", 116, 293) %>%
  pack_rows("Deleen 90th Percentile", 294, 385)%>%
  pack_rows("Deleen 99th Percentile",386,440 )
...
"Cerebrospinal fluid t-tau:AB1-42 ratio (unit decrease)"  ,                                                                                                                  
"Cardiovascular Risk Factors" ,                                                                                                                               
"Cardiovascular Risk Factors" ,                                                                                                                       
"Cardiovascular Risk Factors" ,                                                                                                                                      
"Cardiovascular Risk Factors" ,                                                                                                                                       
...
"Neurological",                                                                                                                                            
"Neurological",                                                                                                                   
"Dentures (unit increase)" , # should this be GI or musculoskeletal                                                                                                                                                 
"Neurological",                                                                                                                                              
"Neurological",                                                                                                                                       
"Cardiovascular Risk Factors" ,                                                                                                                                 
"Cardiovascular Risk Factors" ,                                                                                                                                 
...
"Neurological",                                                                                                                
"Neurological",                                                                                                               
"Cardiovascular Risk Factors" , #fibrinogen risk factor for CHD                                                                                                                                        
"Neurological",                                                                                                                              
"Neurological",                                                                                                                            
"Neurological",                                                                                                                            
"Cardiovascular Risk Factors" ,                                                                             
...
"Menopause (age at onset) (year increase)"  ,                                                                                                                                
 "Metabolic syndrome (bivariate traits) (unit decrease)",                                                                                                                     
"Metabolic syndrome (bivariate traits) (unit increase)"  ,                                                                                                                   
"Metabolic syndrome (unit increase)"      ,                                                                                                                                  
"Metabolite levels (mg/dL decrease)"  ,                                                                                                                                      
"Metabolite levels (unit increase)"  ,                                                                                                                                       
"Cancer",                                                                                                                    
"Cardiovascular Outcome",                                                                                                                                                
"Cardiovascular Outcome",                                                                                                                                    
"N-glycan levels (zscore) increase)"  ,                                                                                                                                      
"Neurological",                                                                                                                                       
"Number of decayed, missing and filled tooth surfaces or use of dentures (unit increase)"   ,                                                                                
"Cardiovascular Risk Factors" ,                                                                                                                                                         
"Cardiovascular Risk Factors" ,                                                                                                                                          
"Parental longevity"   ,                                                                                                                                       
"Parental longevity"   ,                                                                                                           
...
"Parental longevity"   ,                                                                                                                
"Parental longevity"   ,                                                                                                                
"Cardiovascular Risk Factors" ,  #   18987306                                                                                                                             
"Cardiovascular Risk Factors" ,                                                                                                                                            
"Cardiovascular Risk Factors" ,                                                                                                                                            
"Cardiovascular Risk Factors" ,                                                                                                                                           
"Cardiovascular Risk Factors" ,                                                                                                                                          
"Behavioral"  ,                                                                                                              
"Behavioral"  ,                                                                                                             
"Resistance to Mycobacterium tuberculosis in HIV-positive individuals measured by a negative tuberculin skin test (continuous) (unit decrease)" ,                            
"Cardiovascular Drug" , 
...
"Behavioral"  ,                                                                                                                  
"Cancer",                                                                                                                                            
"Sweet taste perception in obesity with metabolic syndrome (unit decrease)" ,                                                                                                
"Cardiovascular Risk Factors" ,                                                                                                                                  
"Cardiovascular Risk Factors" ,                                                                                                                              
"Cardiovascular Risk Factors" ,                                                                                                                                  
"Cardiovascular Risk Factors" ,                                                                                                                                  
...
sel_tab <- dat_all %>% filter(Pilling == "YES" & Timmers == "YES" & Cases90 == "YES" & Cases99 == "YES") %>% 
  ...
  mutate(Groups = table5b_groups)%>%
  select(Groups, exposure,  b.pilling, b.timmers,  b.90, b.99, se.pilling, se.timmers, se.90, se.99, nsnp.pilling, nsnp.timmers, nsnp.90, nsnp.99,pval.pilling, pval.timmers,  pval.90,  pval.99, Adjusted.p.Pilling,  Adjusted.p.Timmers,  Adjusted.p.Cases90,  Adjusted.p.Cases99, Exposure.Dataset)%>%
   filter(exposure %in% c("Alzheimer's disease or family history of Alzheimer's disease (NR z-unit increase)", "Thyroid peroxidase antibody levels", "Rheumatoid arthritis (NA)", "Urinary albumin excretion (unit increase)",  "Age of smoking initiation (MTAG) (unit decrease)", "Systolic blood pressure (unit increase)", "Age at first sexual intercourse", "Educational attainment (years of education) (unit decrease)", "Depressive symptoms (unit increase)", "Highest math class taken (MTAG) (unit increase)",    "Well-being spectrum (multivariate analysis) (unit increase)", "Coronary artery disease (unit decrease)", "Medication use (agents acting on the renin-angiotensin system) (unit increase)", "Parental longevity (both parents in top 10%) (unit increase)", "Antipsychotic drug-induced QTc interval change in schizophrenia (unit increase)", "Breast cancer (unit increase)", "Total hippocampal volume (NR mm3 decrease)" ))
...
scatter <- plot_grid(sc.pilling$tN6HnW.LdDskh,sc.timmers$tN6HnW.j549T5, sc.cases90$tN6HnW.m77bQk, sc.cases99$tN6HnW.336pZh, nrow = 2)
...
scatter <- plot_grid(sc.pilling$`5Aylo5.USIT8B`,sc.timmers$`5Aylo5.g9uqBL`, sc.cases90$`5Aylo5.sR5E27`, sc.cases99$`5Aylo5.AepDrU`, nrow = 2)
...
scatter <- plot_grid(sc.pilling$quz6Ic.wGQyap,sc.timmers$quz6Ic.DOwmAi, sc.cases90$quz6Ic.dr9lB8, sc.cases99$quz6Ic.Dx4DDx, nrow = 2)
...
scatter <- plot_grid(sc.pilling$`5ayOJm.JMohXy`,sc.timmers$`5ayOJm.Crg7oO`, sc.cases90$`5ayOJm.CZ2W0c`, sc.cases99$`5ayOJm.9kVPpK`, nrow = 2)
...
scatter <- plot_grid(sc.pilling$zfDkhg.LuHNZI,sc.timmers$zfDkhg.DCkH3i, sc.cases90$zfDkhg.139wxi, sc.cases99$zfDkhg.fEV7lE, nrow = 2)
...
scatter <- plot_grid(sc.pilling$H4GR84.pIhAYz,sc.timmers$H4GR84.Cbklct, sc.cases90$H4GR84.rRNsxB, sc.cases99$H4GR84.5OTyoE, nrow = 2)
...
scatter <- plot_grid(sc.pilling$wKtcK4.wWKjwT,sc.timmers$wKtcK4.7fMQvl, sc.cases90$wKtcK4.ljK9vY, sc.cases99$wKtcK4.ij0kZ5, nrow = 2)
...
scatter <- plot_grid(sc.pilling$sV1BuI.WVd3J9,sc.timmers$sV1BuI.Bge8U8, sc.cases90$sV1BuI.iFGxC6, sc.cases99$sV1BuI.U236Iq, nrow = 2)
...
scatter <- plot_grid(sc.pilling$Jen27f.AYzCh7,sc.timmers$Jen27f.212aDw, sc.cases90$Jen27f.0BlGHh, sc.cases99$Jen27f.4T6Y42, nrow = 2)
...
scatter <- plot_grid(sc.pilling$GzAO0e.hEA2rq,sc.timmers$GzAO0e.LXSykz, sc.cases90$GzAO0e.yh1lsC, sc.cases99$GzAO0e.POTqCs, nrow = 2)
...
scatter <- plot_grid(sc.pilling$ibxGjq.AHgBXj,sc.timmers$ibxGjq.cwy7u0, sc.cases90$ibxGjq.J1WXa3, sc.cases99$ibxGjq.68sRta, nrow = 2)
...
scatter <- plot_grid(sc.pilling$`50z18q.CFV8Id`,sc.timmers$`50z18q.4sinqU`, sc.cases90$`50z18q.GJtqPX`, sc.cases99$`50z18q.6qvjH8`, nrow = 2)
...
scatter <- plot_grid(sc.pilling$`5wocjM.PYXxnt`,sc.timmers$`5wocjM.dPYMyA`, sc.cases90$`5wocjM.GKkvgF`, sc.cases99$`5wocjM.uyxBkp`, nrow = 2)
...
scatter <- plot_grid(sc.pilling$`9b38W5.OHxkGR`,sc.timmers$`9b38W5.38nTHY`, sc.cases90$`9b38W5.JyQ9FY`, sc.cases99$`9b38W5.AE2Auw`, nrow = 2)
...
scatter <- plot_grid(sc.pilling$qMfso7.uf8eeB,sc.timmers$qMfso7.3eLfQs, sc.cases90$qMfso7.QDMIQr, sc.cases99$qMfso7.bMqMCE, nrow = 2)
