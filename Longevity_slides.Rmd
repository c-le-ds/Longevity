...
```{r}
table1_Groups <- c("Cardiovascular Drug", "Cardiovascular Outcome", "Cardiovascular Drug", "Parental Longevity", "Cardiovascular Outcome",  "Cardiovascular Risk Factors",  "Cardiovascular Risk Factors" , "Smoking", "Education",  "Cardiovascular Risk Factors", "Education",  "Cardiovascular Risk Factors",  "Cardiovascular Outcome", "Cardiovascular Risk Factors" ,   "Cardiovascular Risk Factors"  , "Education",  "Cardiovascular Risk Factors" , "Smoking", "Other",   "Cardiovascular Drug" ,  "Cardiovascular Risk Factors" ,  "Cardiovascular Risk Factors" ,"Other","Cardiovascular Risk Factors",  "Cardiovascular Risk Factors" ,  "Cardiovascular Outcome" ,  "Cardiovascular Risk Factors",  "Cardiovascular Outcome", "Cardiovascular Drug", "Other",  "Cardiovascular Outcome" )
...
"Cardiovascular Risk Factors", 
"Cancer",
"Neuroticism (MTAG) (unit increase)", 
"Cardiovascular Risk Factors" ,
"Hippocampal tail volume (corrected for total hippocampal volume) (NR mm3 decrease)" ,  
...
"Cognitive performance (MTAG) (unit increase)" , 
"Cardiovascular Risk Factors" , 
"Intelligence (MTAG) (unit decrease)" , 
"Smoking" , 
...
"Cardiovascular Risk Factors" ,  
"Cardiovascular Risk Factors" , 
"Self-reported math ability (MTAG) (unit decrease)",
"Squamous cell lung carcinoma", 
"Cardiovascular Drug" ,  
"Cardiovascular Risk Factors" , 
"Cardiovascular Risk Factors" , 
"Sleep time (unit decrease)", 
"Educational attainment (years of education) (NR unit decrease)",
"Cardiovascular Risk Factors" , 
"Cardiovascular Risk Factors"   , 
"Cardiovascular Risk Factors"   ,
"Cigarettes smoked per day (MTAG) (unit increase)" , 
"Lipoprotein(a) levels adjusted for apolipoprotein(a) isoforms (unit increase)" , 
"Antipsychotic drug-induced QTc interval change in schizophrenia (unit increase)" , 
"Cardiovascular Risk Factors"  ,
"Parental lifespan (years decrease)" ,
"Parental longevity (combined parental attained age, Martingale residuals) (unit increase)",
"Highest math class taken (unit increase)" , 
"Type 2 diabetes (unit increase)"  ,
"Cardiovascular Risk Factors"  ,
"Self-reported math ability (MTAG) (unit increase)",
"Highest math class taken (MTAG) (unit increase)",
"Cognitive performance (unit increase)",
"Cardiovascular Risk Factors" ,
...
"Depressive symptoms (unit increase)"  ,
"Cardiovascular Risk Factors"  ,
"Cardiovascular Risk Factors"  ,
"Cardiovascular Risk Factors"  ,
"Brain structure (mm3 increase)"  , 
"Cardiovascular Risk Factors"  , 
...
"Cardiovascular  Outcome" ,
"Cardiovascular Risk Factors" ,
"Intelligence (MTAG) (unit increase)" , 
"Cardiovascular Risk Factors" ,
"Lung cancer" ,                    
"Cardiovascular Risk Factors" ,
"Cardiovascular Risk Factors"  ,
...
"Educational attainment (years of education) (unit increase)" ,
"Educational attainment (years of education) (NR unit increase)",
"Cardiovascular Risk Factors"   , 
...
"General cognitive ability (z-score increase)" ,
 "Depression (z score increase)"    ,
"Cardiovascular Risk Factors" ,
"Educational attainment (MTAG) (unit decrease)",
"Cardiovascular Risk Factors" ,    
...
"Menopause (age at onset) (year increase)",
 ...
 "Educational attainment (MTAG) (unit increase)" ,
...
"Highest math class taken (MTAG) (unit decrease)" ,
...
"Cardiovascular Outcome",
"Cognitive performance (unit decrease)",
"Cardiovascular Risk Factors",
"Highest math class taken (unit decrease)",
"Cardiovascular Risk Factors" ,
"Cardiovascular Outcome",
"Cardiovascular Risk Factors",
"Cardiovascular Risk Factors"  ,
...
"Smoking",
"Cardiovascular Outcome" , 
 "Cognitive performance (MTAG) (unit decrease)",
"Cardiovascular Risk Factors" ) 
