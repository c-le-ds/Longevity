...
## Common Exposures Tables {.tabset}
...
reactable(table5a, groupBy = "Groups", bordered = TRUE, columns = list(
...
- Rheumatoid Arthritis: this confirms what we know about arthritis and longevity. All four studies show reduction in longevity when Rheumatoid Arthritis is present
  - Only significant in Timmers, however, this might be due to the size of the study. Since Timmers was the largest study we looked at with 1 million observations

- Smoking Status : this confirms what we know about smoking and its association with longevity. 
    - In all four studies there was a decrease in longevity due to smoking status as seen by the negavtive beta coefficients.
    - Again, only significant in Timmers, however, this might be due to the size of the study. Since Timmers was the largest study we looked at with 1 million observations

- Thyroid peroxidase antibody levels: increased levels have been associated with normal thyroid function as a person ages
  - hypothryoid function is associated with increased longevity, lower peroxidase antibody levels can indicated hypothryoid function
  
- Urinary albumin excretion : increased levels are associated with a reduction in longevity as we expect

- Toenail selenium levels :  protects from oxidative stress. 
  - inconsistent estimates across four studies, however both Deleen 99th and 90th percentiles have very large standard errors. 
    - when we construct 95% CI we find that the finding is null and not in the opposite direction.

  - signifcant in only Pilling defined outcome

# Deleen

## Shared Exposures Deleen{.tabset}
...
- Toenail Selenium was significant in Pilling as significant put not in any of the other studies
  - report it as is. 
  - show the variation of support across studies. 
  - potentially interesting but not conclusive. 

- Thyroid peroxidase antibody levels was significant in Deleen 90 but not in other studies
To do:
 - follow up with peroxidase
  - look for exposures associated with thyroid
  thyroid-stimulating hormone (TSH)
  - Dan will come up with a list
 for five exposures
 - sensisivtity analyses
 - do leave one out analyses
 - do MR Egger analyses
  - should i do multitest adjustments?? no
 - F test for weak instruments 
  - median based estimator

- take associations significant in IVV, take betas
- take MR Eggers, take betas
- take median estimator, take betas


- Thyroid peroxidase antibody levels was significant in Deleen 90 but not in other studies
 - follow up with peroxidase, sensitivity analyses
 - do leave one out analyses
 - do MR Egger analyses
- make scatter plot of the three combinations. look for significant departures as betas increase
...
To do : highlights for each table with "selected" exposures
RA
Thyroid peroxidase
Urinary Albumin
Smoking - Ever/Never
...
- consistency of the direction of the beta coefficients across the different outcomes
  - in particular, Toenail Selenium and Thyroid peroxidase antibody


regroup 
create behavioral : age at intercourse, smoking, well-being
metabolites should be on their own
muscluoskeletal : grip and RA

Have a separate table for metabolites on a separate tab.
...
Gesing, A., Lewiński, A. & Karbownik-Lewińska, M. The thyroid gland and the process of aging; what is new?. Thyroid Res 5, 16 (2012). https://doi.org/10.1186/1756-6614-5-16
