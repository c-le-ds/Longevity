...
reactable(dat, filterable = TRUE, paginationType = "jump", showSortable = TRUE,
          columns = list(
            exposure = colDef(name = "Exposure"),
...
Table 2. Significant Exposures (adjusted p-value $\leq$ 0.05) Among All Four Outcomes
```{r}
...
dat_all %>% filter(Pilling == "YES" & Timmers == "YES" & Cases90 == "YES" & Cases99 == "YES") %>%
  ...
  select(exposure, b.pilling, se.pilling,  Adjusted.p.Pilling,  b.timmers, se.timmers, Adjusted.p.Timmers,  b.90, se.90,  Adjusted.p.Cases90,b.99, se.99, Adjusted.p.Cases99, Exposure.Dataset) %>%
...
Table 3. Significant Exposures (adjusted p-value $\leq$ 0.05) found in the Two UK Biobank Studies
```{r}
...
## Common Exposures Among Deleen 

Table 3. Significant Exposures (adjusted p-value $\leq$ 0.05) found in both Deleen Outcomes 
...
select(exposure, Exposure.Dataset.Timmers) %>%
  reactable(columns = list(
            exposure = colDef(name = "Exposure"),
